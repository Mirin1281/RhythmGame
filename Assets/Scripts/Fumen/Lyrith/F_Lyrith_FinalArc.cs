...
namespace NoteGenerating
{
    ...
    public class F_Lyrith_FinalArc : Generator_3D
    {
        ...
        protected override async UniTask GenerateAsync()
        {
            ...
            {
                new(new(-6, 0, 0), ArcVertexMode.Linear, false, false, 0, 2),
                new(new(-6, 0, 2), ArcVertexMode.Linear, false, false, 0, 2),
                new(new(-6, 0, 2), ArcVertexMode.Linear, false, false, 0, 2),
                new(new(-6, 0, 2), ArcVertexMode.Linear, false, false, 0, 2),
                new(new(-6, 0, 2), ArcVertexMode.Linear, false, false, 0, 2),
                new(new(-6, 0, 2), ArcVertexMode.Linear, false, false, 0, 2),
                new(new(-6, 0, 2), ArcVertexMode.Linear, false, false, 0, 2),
                new(new(-6, 0, 2), ArcVertexMode.Linear, false, false, 0, 2),
                new(new(-6, 0, 4), ArcVertexMode.Linear, false, false, 0, 8),
                new(new(-6, 0, 2), ArcVertexMode.Linear, true),
            }).Forget();
            MyArc(new ArcCreateData[]
            {
                new(new(-2, 0, 0), ArcVertexMode.Linear, false, false, 0, 2),
                new(new(-2, 0, 2), ArcVertexMode.Linear, false, false, 0, 2),
                new(new(-2, 0, 2), ArcVertexMode.Linear, false, false, 0, 2),
                new(new(-2, 0, 2), ArcVertexMode.Linear, false, false, 0, 2),
                new(new(-2, 0, 2), ArcVertexMode.Linear, false, false, 0, 2),
                new(new(-2, 0, 2), ArcVertexMode.Linear, false, false, 0, 2),
                new(new(-2, 0, 2), ArcVertexMode.Linear, false, false, 0, 2),
                new(new(-2, 0, 2), ArcVertexMode.Linear, false, false, 0, 2),
                new(new(-2, 0, 4), ArcVertexMode.Linear, false, false, 0, 8),
                new(new(-2, 0, 2), ArcVertexMode.Linear, true),
            }).Forget();
            ...
            for(int i = 0; i < waits.Length; i++)
            {
                ...
                if(i < waits.Length / 2)
                {
                    ...
                    {
                        new(new(0, 0, 0), ArcVertexMode.Linear, false, false, 0, 8),
                ...
                else
                {
                    MyArc2(new ArcCreateData[]
                    {
                        new(new(6, 0, 0), ArcVertexMode.Linear, false, false, 0, 8),
                        new(new(-6, 0, 8), ArcVertexMode.Linear, true),
                    },
                    speed);
                    await Wait(waits[i]);
